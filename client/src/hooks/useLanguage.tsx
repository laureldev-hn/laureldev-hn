...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'services.mobile.title': 'Mobile Banking',
    'services.mobile.description': 'Custom mobile applications with intuitive interfaces and secure functionality.',
    'services.security.title': 'Security & Compliance',
    'services.security.description': 'Advanced security measures and compliance solutions to protect your data.',
    'services.analytics.title': 'Data Analytics',
    'services.analytics.description': 'Powerful analytics tools to derive insights and drive informed decisions.',
    'services.payments.title': 'Payment Processing',
    'services.payments.description': 'Seamless and secure payment processing solutions for all transaction types.',
    'services.ai.title': 'AI & Machine Learning',
    'services.ai.description': 'Intelligent automation and predictive analytics for enhanced member experiences.',
  ...
  es: {
    ...
    'services.mobile.title': 'Banca Móvil',
    'services.mobile.description': 'Aplicaciones móviles personalizadas con interfaces intuitivas y funcionalidad segura.',
    'services.security.title': 'Seguridad y Cumplimiento',
    'services.security.description': 'Medidas de seguridad avanzadas y soluciones de cumplimiento para proteger sus datos.',
    'services.analytics.title': 'Análisis de Datos',
    'services.analytics.description': 'Potentes herramientas de análisis para obtener información y tomar decisiones informadas.',
    'services.payments.title': 'Procesamiento de Pagos',
    'services.payments.description': 'Soluciones de procesamiento de pagos seguras y fluidas para todo tipo de transacciones.',
    'services.ai.title': 'IA y Aprendizaje Automático',
    'services.ai.description': 'Automatización inteligente y análisis predictivo para mejorar la experiencia de los miembros.',
